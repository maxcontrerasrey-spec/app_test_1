...
create index if not exists idx_candidate_documents_case_profile_type
  on public.candidate_documents(recruitment_case_id, candidate_profile_id, document_type_id);
