drop function if exists public.add_hr_incentive_rate_rule(uuid, numeric, text, text, integer, date, date);
drop function if exists public.add_hr_incentive_rate_rule(uuid, numeric, text, text, text, integer, date, date);
drop function if exists public.resolve_hr_incentive_rate_rule(uuid, text, text, date);
drop function if exists public.resolve_hr_incentive_rate_rule(uuid, text, text, text, date);
...
revoke all on function public.add_hr_incentive_rate_rule(uuid, numeric, text, text, text, text, integer, date, date) from public, anon, authenticated;
grant execute on function public.add_hr_incentive_rate_rule(uuid, numeric, text, text, text, text, integer, date, date) to authenticated;
...
grant execute on function public.resolve_hr_incentive_rate_rule(uuid, text, text, text, text, date) to authenticated;
