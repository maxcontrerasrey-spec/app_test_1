...
revoke all on function public.user_can_access_recruitment_personnel(uuid) from public, anon, authenticated;
grant execute on function public.user_can_access_recruitment_personnel(uuid) to service_role;

revoke all on function public.user_can_manage_recruitment_personnel_candidate(uuid, uuid) from public, anon, authenticated;
grant execute on function public.user_can_manage_recruitment_personnel_candidate(uuid, uuid) to service_role;
