-- Hotfix: las aprobaciones WHO se resuelven operativamente desde el centro de
-- mando (`/`), no desde Control de Contrataciones. El correo y cualquier
-- recordatorio futuro deben abrir la bandeja correcta.
...
begin
  ...
  from (
    ...
    where rc.capability_code = 'can_approve_who_stage'
      and p.status = 'active'
