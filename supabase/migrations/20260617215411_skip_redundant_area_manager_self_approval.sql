...
begin
  ...
  skip_area_manager_approval := area_manager_record.approver_user_id = current_user_id;
  ...
  values (
    ...
    jsonb_build_object(
      ...
      'approver_user_id', area_manager_record.approver_user_id,
      'approver_name', area_manager_record.approver_name,
      'approver_email', coalesce(area_manager_record.approver_email, area_manager_profile.email),
