...
alter table public.recruitment_dsal_roster
  add column if not exists is_union_representative boolean not null default false;

update public.recruitment_dsal_roster
   set is_union_representative = true,
       updated_at = timezone('utc', now())
 where national_id in ('123490827', '103898684', '122379817');
