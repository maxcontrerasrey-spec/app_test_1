...
} from "../lib/templateBuilderForms";
import { TemplateBuilderTaskList } from "../components/TemplateBuilderTaskList";
    ...
    <section className="info-card">
      ...
      <div style={{ padding: "0 1.5rem 1.5rem", display: "grid", gap: "1.5rem" }}>
        ...
        <TemplateBuilderTaskList
          ...
          handleEditingTaskFieldChange={handleEditingTaskFieldChange}
        />
      </div>
    </section>
  );
