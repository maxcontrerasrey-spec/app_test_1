...
import {
  ...
  type BaseRegisterDraftSnapshot,
  buildRemoteOperationsServices,
  getBaseRegisterDraftKey,
  hasMeaningfulServiceDrafts,
  normalizeOperationsContractLabel,
  readBaseRegisterDraft,
  removeBaseRegisterDraft,
  sortOperationsContracts
} from "../lib/operacionesDashboardConfig";
  ...
  useEffect(() => {
    ...
    async function loadSessionData() {
      ...
      try {
        ...
        const normalizedRemoteData = buildRemoteOperationsServices(
          rows as BaseServiceQueryRow[] | null | undefined,
          contractsCatalogRows as Array<{ id: number | string; code: string | null; contract_name: string | null }> | null | undefined
        );
