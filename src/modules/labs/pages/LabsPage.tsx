    ...
    <PageShell>
      ...
      <div className="labs-paper-wrapper">
        <section className="ink-paper">
          ...
          <p className="ink-text">
            Esta sección valida la integración compartida de Apache ECharts dentro de la app. El objetivo no es solo visualizar un gráfico, sino confirmar lectura, responsive y consistencia visual con la capa compartida actual.
          </p>
          <Suspense fallback={<p className="ink-text">Cargando showcase de ECharts...</p>}>
            <EChartsShowcase />
          </Suspense>
