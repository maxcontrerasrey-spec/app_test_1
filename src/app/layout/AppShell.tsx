        ...
        <div className="top-shell-bar">
          ...
          <div className="top-nav-stage">
            <nav className="top-nav" aria-label="Modulos">
              ...
              >
                <img src={orionLogo} alt="ORION" style={{ width: "18px", height: "18px", objectFit: "contain", filter: "invert(0.5) sepia(1) saturate(5) hue-rotate(200deg)" }} className="orion-nav-icon" />
                <span>ORION</span>
              </NavLink>
