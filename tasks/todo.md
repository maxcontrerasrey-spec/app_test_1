...
- Validación local cerrada con `npm run build` y `git diff --check`. La migración `20260612130334` ya quedó registrada en Supabase productivo; queda pendiente aplicar `20260612133601` para no bloquear a aprobadores legítimos fuera del rol base de Recursos Humanos.
